...
class Mosaic{
    ...
    public:
        ...
        */
        ...
        /*
        * Converts a colour integer to a coloured string
        * @param colour Colour of the item to be printed
        */
        std::string convertIntToColouredString(int colour);
        std::string convertEmptyToColouredString(int row, int col);
        /*
        * Prints a wall row.
        ...
        */
        ...
        int countEmptyTilesInWallRow(int row);
        
        int countEmptyTilesInPatternLineRow(int row);

        int findColourOfPatternLine(int row);
