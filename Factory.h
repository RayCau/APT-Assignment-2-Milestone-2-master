...
class Factory{
    public:
        ...
        */
        ...
        /*
        *   Finds the tile that has the greatest amount in the factory
        *   @return integer colour of tile that has greatest count
        */
        int findColourOfGreatestAmountTile();

        /*
        *   Finds the tile that has the least amount in the factory
        *   @return integer colour of tile that has least count
        */
        int findColourOfLeastAmountTile();
        /*
        ...
        */
        ...
        /*
        * Setter for the centre boolean variable
        * @Param centre Boolean to set the centre variable
        */
        void setCentre(bool centre);
        
        /*
        * Getter for the centre boolean variable
        */
        bool isCentre();
